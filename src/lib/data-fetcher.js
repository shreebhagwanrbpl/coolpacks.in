...
export async function fetchHomeData() {
    return fetchDocCached("websites/coolpacksin/pages/home");
}

export async function fetchContactData() {
    return fetchDocCached("websites/coolpacksin/pages/contact");
}

export async function fetchServicesData() {
    return fetchDocCached("websites/coolpacksin/pages/services");
}

export async function fetchDistrictData(district) {
    if (!district) return null;
    return fetchDocCached(`websites/coolpacksin/districts/${district}`);
}
...
export function subscribeToCatalog(onUpdate) {
    ...
    try {
        const legacyUnsub = onSnapshot(
            doc(db, "websites", "coolpacksin", "pages", "products"),
            (docSnap) => {
                if (docSnap.exists()) {
