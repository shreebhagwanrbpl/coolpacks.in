...
export default function Footer() {
  ...
  useEffect(() => {
    const loadDistrict = async () => {
      ...
      try {
        const snap = await getDoc(
          doc(db, "websites", "coolpacksin", "districts", district)
        );
  ...
  return (
    <footer className="border-t border-slate-200 bg-gradient-to-b from-white via-slate-50 to-slate-100/70">
            ...
            <div className="flex flex-col gap-3 text-sm font-medium">
              {[
                ...
                <Link
                  ...
                  className="text-slate-600 transition-all duration-300 hover:translate-x-1.5 hover:text-slate-900 flex items-center gap-1.5"
                >
